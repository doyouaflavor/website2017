...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix node-<?php print $node->nid; ?>" role="article"<?php print $attributes; ?>>
	<?php if ( $title || $user_picture || $display_submitted ) : ?>
		<header class="node-header clearfix">
			<!-- Node title -->
			<?php if ( $title && !$page ) :
				print render( $title_prefix ); ?>
					<h6 class="title node-title"<?php print $title_attributes; ?>>
			...
			<?php if ( $display_submitted ) : ?>
				<div class="submitted node-submitted" role="contentinfo">
					...
					<span class="node-comments">
						<span class="fa fa-comment"></span>
						<a href="<?php echo $node_url;?>#comments"><?php print $comment_count . t( " Comments" ); ?> </a>
					</span>
				</div>
			<?php endif; ?>
		</header>
